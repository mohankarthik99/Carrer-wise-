var Global = function () {
    ...
    var logoFix=function(){
       var fix= function (){
  const element = document.querySelector('.s-holder_logo-img');
  if (window.innerWidth < 368) {
    ...
    var scrollFix=function(){
        document.querySelector('circle').addEventListener("click", function () {
            document.querySelector('.s-header__trigger-icon').classList.toggle('g-bg-color--white');
        });
         ...
         $(window).scroll(function () {
             ...
             if ($(this).scrollTop() > 0) {
                 $('#hideit').hide();
                 $('.s-header__trigger-icon').css("background","black");
             } else {
                                  $('.s-header__trigger-icon').css("background", "white");
